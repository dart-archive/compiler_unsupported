...
import 'package:compiler_unsupported/_internal/front_end/src/fasta/kernel/redirecting_factory_body.dart' as ir;
import 'package:compiler_unsupported/_internal/kernel/ast.dart' as ir;
import 'package:compiler_unsupported/_internal/kernel/clone.dart';
...
class ClassEnvImpl implements ClassEnv {
  ...
  /// Copied from 'package:compiler_unsupported/_internal/kernel/transformations/mixin_full_resolution.dart'.
  ...
  void _ensureMaps(KernelToElementMapBase elementMap) {
    ...
    if (isUnnamedMixinApplication && _constructorMap.isEmpty) {
      ...
      // 'package:compiler_unsupported/_internal/kernel/transformations/mixin_full_resolution.dart'
