...
/// Implementation for the `package:compiler_unsupported/_internal/front_end/kernel_generator.dart` and
/// `package:compiler_unsupported/_internal/front_end/summary_generator.dart` APIs.
